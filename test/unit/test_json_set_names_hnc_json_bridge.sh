...
cp "$(dirname "$0")/../../bin/hnc_json" "$DIR/bin/hnc_json"
cp "$(dirname "$0")/../../bin/json_set.sh" "$DIR/bin/json_set.sh"
cp "$(dirname "$0")/../../bin/json_guard.sh" "$DIR/bin/json_guard.sh" 2>/dev/null || true
